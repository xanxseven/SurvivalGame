 ...
 * @returns {vec3} out
 */
export function cross(out: Vec2, a: Vec2, b: Vec2): Float32Array{
 ...
 * @returns {vec2} out
 */
export function transformMat2d(out: Vec2, a: Vec2, m: Float32Array): Vec2 {
  var x = a[0],
    y = a[1];
 ...
 * @returns {vec2} out
 */
export function transformMat4(out: Vec2, a: Vec2, m: Float32Array) {
  let x = a[0];
  let y = a[1];
